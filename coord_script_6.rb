...
insert_params = [
  { sn_x: (2101.0000 + 299.3000), sn_y: 5541.5300, columns: 1, rows: 21, column_vector: [0, 0], row_vector: [0, 200 / ly.dbu] },
  { sn_x: (2101.0000 + 299.3000) + 1400.0000, sn_y: 5541.5300, columns: 1, rows: 21, column_vector: [0, 0], row_vector: [0, 200 / ly.dbu] },
  { sn_x: (2101.0000 + 299.3000) + 2 * 1400.0000, sn_y: 5541.5300, columns: 1, rows: 21, column_vector: [0, 0], row_vector: [0, 200 / ly.dbu] },
  
  
  
  { sn_x: 1493.7000, sn_y: (5351.5300 - 400), columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 1493.7000, sn_y: (5351.5300 - 400) - 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 1493.7000, sn_y: (5351.5300 - 400) - 2 * 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  
  { sn_x: 2893.7000, sn_y: (5351.5300 - 400), columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 2893.7000, sn_y: (5351.5300 - 400) - 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 2893.7000, sn_y: (5351.5300 - 400) - 2 * 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  
  { sn_x: 4293.7000, sn_y: (5351.5300 - 400), columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 4293.7000, sn_y: (5351.5300 - 400) - 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 4293.7000, sn_y: (5351.5300 - 400) - 2 * 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] }

]

# Insert "6" instances based on the parameters array
mag = 10
