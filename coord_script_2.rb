...
insert_params = [
  { sn_x: 1801.70000, sn_y: 5541.53000, columns: 1, rows: 21, column_vector: [0, 0], row_vector: [0, 200 / ly.dbu] },
  { sn_x: 1801.70000 + 1400.0000, sn_y: 5541.53000, columns: 1, rows: 21, column_vector: [0, 0], row_vector: [0, 200 / ly.dbu] },
  { sn_x: 1801.70000 + 2 * 1400.0000, sn_y: 5541.53000, columns: 1, rows: 21, column_vector: [0, 0], row_vector: [0, 200 / ly.dbu] },
  
  { sn_x: 1493.70000, sn_y: 5351.53000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 1493.70000, sn_y: 5351.53000 - 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 1493.70000, sn_y: 5351.53000 - 2 * 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  
  { sn_x: 2893.70000, sn_y: 5351.53000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 2893.70000, sn_y: 5351.53000 - 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 2893.70000, sn_y: 5351.53000 - 2 * 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  
  { sn_x: 4293.70000, sn_y: 5351.53000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 4293.70000, sn_y: 5351.53000 - 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] },
  { sn_x: 4293.70000, sn_y: 5351.53000 - 2 * 1400.0000, columns: 5, rows: 1, column_vector: [300 / ly.dbu, 0], row_vector: [0, 0] }

]

# Insert "2" instances based on the parameters array
mag = 10
